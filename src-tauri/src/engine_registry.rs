...
fn definitions() -> Vec<EngineDefinition> {
    vec![
        EngineDefinition {
            ...
            license: open_source(
                "LGPL 开源引擎；AutoMD 提供安装/容器/编译 recipe，不直接捆绑二进制。",
            ),
            ...
            execution_modes: vec![
                ...
                ExecutionMode::CondaEnvironment,
        ...
        EngineDefinition {
            ...
            maturity: EngineMaturity::FirstClass,
            license: open_source(
                "MIT/LGPL 生态；通过 Python 侧车环境安装并由 AutoMD 调用脚本模板。",
            ),
            platform_support: all_desktop_platforms(),
        ...
        EngineDefinition {
            ...
            license: free_toolkit(
                "AmberTools 可自由获取；AutoMD 优先调用 tleap/sander/cpptraj 等工具。",
            ),
            platform_support: all_desktop_platforms(),
            ...
            notes: vec![
                "首版用于 Amber 输入生态和轻量本地运行。",
                "pmemd/pmemd.cuda 作为受限 AMBER 模块单独处理。",
            ],
        },
        EngineDefinition {
            id: "lammps",
        ...
        EngineDefinition {
            ...
            maturity: EngineMaturity::ExternalOnly,
            license: restricted(
                "AutoMD 不分发 AMBER pmemd；用户需自行获取 AMBER 许可并配置 pmemd/pmemd.cuda。",
            ),
            platform_support: all_desktop_platforms(),
        ...
        EngineDefinition {
            ...
            maturity: EngineMaturity::ExternalOnly,
            license: restricted(
                "AutoMD 只提供 CHARMM 适配器入口；用户需自行获取许可并配置可执行文件。",
            ),
            platform_support: linux_first_platforms(),
        ...
        EngineDefinition {
            ...
            maturity: EngineMaturity::ExternalOnly,
            license: commercial(
                "AutoMD 不分发 Desmond；用户需在自己的 Schrodinger 授权环境中配置。",
            ),
            platform_support: linux_first_platforms(),
